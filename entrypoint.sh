...
VMESS_WSPATH=${VMESS_WSPATH:-'/uffipm'}
VMESS_WARP_WSPATH=${VMESS_WARP_WSPATH:-'/uffipm_warp'}
VLESS_WSPATH=${VLESS_WSPATH:-'/uffipl'}
VLESS_WARP_WSPATH=${VLESS_WARP_WSPATH:-'/uffipl_warp'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/uffipt'}
TROJAN_WARP_WSPATH=${TROJAN_WARP_WSPATH:-'/uffipt_warp'}
